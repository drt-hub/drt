...
class OtelConfig(BaseModel):
    ...
    # "batch" (default) exports spans off the sync's critical path on a
    # background thread; "simple" exports synchronously on span end (handy for
    # local debugging, but blocks the calling thread per span).
