...
def _run_sync_body(
    *,
    ...
    # default user-facing behaviour is unchanged. total_result.dry_run (set
    # above) lets a persisting observer refuse to record a cursor/run for
