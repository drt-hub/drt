...
SOURCE_CONFIG_CLASSES: dict[str, type] = {
    ...
    "deltalake": _creds.DeltaLakeProfile,
    "duckdb": _creds.DuckDBProfile,
    "iceberg": _creds.IcebergProfile,
...
DESTINATION_CONFIG_CLASSES: dict[str, type[BaseModel]] = {
    ...
    "databricks": _models.DatabricksDestinationConfig,
    "discord": _models.DiscordDestinationConfig,
    "elasticsearch": _models.ElasticsearchDestinationConfig,
    "email_smtp": _models.EmailSmtpDestinationConfig,
    "file": _models.FileDestinationConfig,
    "gcs": _models.GCSDestinationConfig,
    ...
    "s3": _models.S3DestinationConfig,
    "salesforce_bulk": _models.SalesforceBulkDestinationConfig,
